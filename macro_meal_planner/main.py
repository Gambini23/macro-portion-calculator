...
st.markdown(
    "**Grammatura corrispondente (totale):**  \n"
...
if st.button("Genera piano pasti completo"):
    ...
    for nome, perc in distrib.items():
        ...
        # Calcolo grammi macro per il pasto
        macros_pasto = {
        ...
        st.write(f"Carboidrati: {macros_pasto['carbs']}g")
        st.write(f"Proteine: {macros_pasto['protein']}g")
        st.write(f"Grassi: {macros_pasto['fat']}g")
