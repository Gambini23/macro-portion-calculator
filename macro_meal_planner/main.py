...
# Mostro la grammatura corrispondente delle macro totali (giornaliere)
with st.columns(1)[0]:
    st.markdown(
...
# Controllo che le percentuali pasti e macro sommino a 100%
...
if st.button("Genera piano pasti completo"):
    ...
    for nome, perc in distrib.items():
        ...
        macros_kcal = {m: kcal_pasto * p for m, p in macro_percent.items()}

        # Chiamo la funzione che ritorna alimenti con grammatura per kcal esatte per macro
